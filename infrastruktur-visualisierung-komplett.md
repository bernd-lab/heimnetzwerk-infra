...
**Alternative GitLab-URL** (falls relativer Pfad nicht funktioniert):
![Infrastruktur-Diagramm](https://gitlab.k8sops.online/neue-zeit/heimnetzwerk-infra/-/raw/main/docs/infrastruktur-diagramm.png)
